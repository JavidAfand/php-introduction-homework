                ...
                <div class="container">
                    <div class="pricing-inner section-inner has-top-divider">
                        ...
                        <div class="pricing-tables-wrap">
                            ...
                            <?php
                                $prices = array("Beginner" => 30, "Middle" => 50, "Professional" => 102, "Student" => 15, "Teacher" => 20, "Kids" => 8);
                            ?>
                            
                            <?php foreach ($prices as $person => $value): ?>
                            <div class="pricing-table">
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            <div class="pricing-table-title mt-12 mb-8"><?php echo $person; ?></div>
                                            <div class="pricing-table-price mb-32 pb-24"><span class="pricing-table-price-currency h4">$</span><span class="pricing-table-price-amount h2"><?php echo $value; ?></span>/mo</div>
                                        </div>
